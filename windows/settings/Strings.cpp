...
StrMap kStringsEn = {
    ...
    {IDC_OPTION_INPUTMODE_HOTKEY,  L"Switch input modes with CTRL + CAPS LOCK"},
    {IDC_OPTION_ALPHA_HOTKEY,      L"Switch to alphanumeric mode with ALT + `"},
    {IDC_OPTION_TELEX,             L"Enable Telex keys (235789 = sfljjw)"},
    {IDC_OPTION_DOTTED_KHIN,       L"Use · (instead of --) for khin"},
    {IDC_OPTION_AUTOKHIN,          L"Automatically khin following syllables"},
...
StrMap kStringsHanlo = {
    ...
    {IDC_OPTION_DOTTED_KHIN,       L"使用 · (無 --) 做輕調符号"},
    {IDC_OPTION_AUTOKHIN,          L"打輕了後、自動共後者變輕"},
    {IDC_OPTION_EASY_CH,           L"EZ ch (打 c 着有 ch)"},

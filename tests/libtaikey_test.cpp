...
BOOST_AUTO_TEST_CASE(TestTonePlacement) {
    TKEngine e;
    e.reset();
    feedKeys(e, u8"uis");
...
BOOST_AUTO_TEST_CASE(TestFailure, *boost::unit_test::expected_failures(1)) {
    TKEngine e;
    e.reset();
    feedKeys(e, u8"a");
...
BOOST_AUTO_TEST_CASE(TestWords) {
...
BOOST_AUTO_TEST_CASE(TestNasal) {
    TKEngine e;
    e.reset();
    feedKeys(e, u8"ann");
...
BOOST_AUTO_TEST_CASE(TestOU_Tone) {
    TKEngine e;
    e.reset();
    feedKeys(e, u8"ous");
...
BOOST_AUTO_TEST_CASE(TestNasal_Tone) {
    TKEngine e;
    e.reset();
    feedKeys(e, u8"annf");
...
BOOST_AUTO_TEST_CASE(TestOU_ToneChange) {
    TKEngine e;
    e.reset();
    feedKeys(e, u8"ousf");
...
BOOST_AUTO_TEST_CASE(TestBackspace) {
    TKEngine e;
    e.reset();
    feedKeys(e, u8"sa\b");
